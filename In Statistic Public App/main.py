...
# def get_posts_per_day_and_hour(username):
#     L = instaloader.Instaloader()
#     profile = instaloader.Profile.from_username(L.context, username)
#     posts_per_day_hour = {}
#
...
#
#         if day_of_week in posts_per_day_hour:
#             if hour_of_day in posts_per_day_hour[day_of_week]:
#                 posts_per_day_hour[day_of_week][hour_of_day] += 1
#             else:
#                 posts_per_day_hour[day_of_week][hour_of_day] = 1
#         else:
#             posts_per_day_hour[day_of_week] = {hour_of_day: 1}
#
#     return posts_per_day_hour
...
if __name__ == "__main__":
    ...
    if submit_button:
        try:
            ...
            # posts_per_day_hour = get_posts_per_day_and_hour(username)
            # st.subheader('Number of Posts per Day and Hour')
            # st.write(posts_per_day_hour)
